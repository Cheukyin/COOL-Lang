                              ...
                              Case(IDENTIFIER('self', 0),
                                   [PatternMatch('n', 'Razz',
                                    ...
                                    PatternMatch('n', 'Foo',
                                                 New('Razz', 0), 0),
                                    PatternMatch('n', 'Bar',
                                                 IDENTIFIER('n', 0), 0)], 0), 0),
                    Attribute('b', 'Int',
                              Add(Add(Add(DynamicDispatch(IDENTIFIER('a', 0), 'doh', [], 0),
                                          DynamicDispatch(IDENTIFIER('g', 0), 'doh', [], 9),
                                          0),
                                      SelfDispatch('doh', [], 0), 0),
                                  SelfDispatch('printh', [], 0), 0), 0),
                    Attribute('f', 'Int',
                              Add(StaticDispatch(IDENTIFIER('a', 0), 'Bazz', 'doh', [], 0),
                                  Add(DynamicDispatch(IDENTIFIER('g', 0), 'doh', [], 0),
                                      DynamicDispatch(IDENTIFIER('e', 0), 'doh', [], 0),
                                      0), 0), 0),
                ],
                   [Method('doh', [], 'Int',
